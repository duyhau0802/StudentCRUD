...
Partial Class HomeScreen
    ...
    Private Sub InitializeComponent()
        ...
        ' btn_add
        ' 
        btn_add.Location = New Point(24, 19)
        btn_add.Margin = New Padding(3, 2, 3, 2)
        btn_add.Name = "btn_add"
        btn_add.Size = New Size(63, 24)
        btn_add.TabIndex = 0
        btn_add.Text = "Add"
        ...
        ' txt_name
        ' 
        txt_name.Location = New Point(72, 56)
        ...
        Label2.Location = New Point(196, 61)
        Label2.Name = "Label2"
        ...
        ' txt_grade
        ' 
        txt_grade.Location = New Point(595, 53)
        txt_grade.Margin = New Padding(3, 2, 3, 2)
        txt_grade.Name = "txt_grade"
        txt_grade.Size = New Size(95, 23)
        txt_grade.TabIndex = 10
        ' 
        ' Label5
        ' 
        Label5.AutoSize = True
        Label5.Location = New Point(547, 58)
        Label5.Name = "Label5"
        ...
        ' btn_delete
        ' 
        btn_delete.Location = New Point(473, 304)
        btn_delete.Margin = New Padding(3, 2, 3, 2)
        btn_delete.Name = "btn_delete"
        btn_delete.Size = New Size(63, 24)
        ...
        ' btn_update
        ' 
        btn_update.Location = New Point(578, 304)
        btn_update.Margin = New Padding(3, 2, 3, 2)
        btn_update.Name = "btn_update"
        btn_update.Size = New Size(63, 24)
        ...
        ' btn_search
        ' 
        btn_search.Location = New Point(473, 91)
        btn_search.Margin = New Padding(3, 2, 3, 2)
        btn_search.Name = "btn_search"
        btn_search.Size = New Size(63, 24)
        ...
        ' btn_clear
        ' 
        btn_clear.Location = New Point(578, 91)
        btn_clear.Margin = New Padding(3, 2, 3, 2)
        btn_clear.Name = "btn_clear"
        btn_clear.Size = New Size(63, 24)
        ...
        DataGridView.Location = New Point(24, 128)
